...
(function () {
    ...
    const ROLE_5_MARCELA = {
        ...
        intro:
            "Im Jahr 2030 verändern sich Marcelas Tätigkeiten: Einige Entscheidungen bleiben klar kreativ-menschlich (Human-Lead), bei anderen helfen schlaue Werkzeuge (KI-Assistenz), und manches läuft im Hintergrund automatisch (Auto-Run).",
    ...
    const ROLE_2_TONI = {
        ...
        intro:
            "Im Jahr 2030 verändern sich Tonis Tätigkeiten: Einige Entscheidungen bleiben klar kreativ-menschlich (Human-Lead), bei anderen helfen schlaue Werkzeuge (KI-Assistenz), und manches läuft im Hintergrund automatisch (Auto-Run).",
        instruction: "Ordne die Tätigkeiten den passenden Bereichen zu:",
        buckets: [
            ...
            { id: "assist", label: "KI-Assistenz", subLabel: "Co-Pilot", color: COLORS.assist, why: "Struktur, Formulier-Vorschläge, Priorisierung – finale Aussage bleibt bei Toni." },
    ...
    const ROLE_3_AHMED = {
        ...
        intro:
            "Im Jahr 2030 verändern sich Ahmeds Tätigkeiten: Einige Entscheidungen bleiben klar menschlich-empathisch (Human-Lead), bei anderen helfen schlaue Werkzeuge (KI-Assistenz), und manches läuft im Hintergrund automatisch (Auto-Run).",
        instruction: "Ordne die Tätigkeiten den passenden Bereichen zu:",
        buckets: [
            ...
            { id: "assist", label: "KI-Assistenz", subLabel: "Co-Pilot", color: COLORS.assist, why: "Vorschläge/Struktur helfen; Entscheidung & Priorität bleiben bei Ahmed." },
    ...
    const ROLE_4_MARIA = {
        ...
        intro:
            "Im Jahr 2030 verändern sich Marias Tätigkeiten: Einige Entscheidungen bleiben klar kreativ-menschlich (Human-Lead), bei anderen helfen schlaue Werkzeuge (KI-Assistenz), und manches läuft im Hintergrund automatisch (Auto-Run).",
        instruction: "Ordne die Tätigkeiten den passenden Bereichen zu:",
        buckets: [
            ...
            { id: "assist", label: "KI-Assistenz", subLabel: "Co-Pilot", color: COLORS.assist, why: "Hinweise, Struktur, Vorgaben – Entscheidung & Formulierung bleiben bei Maria." },
    ...
    const ROLE_1_MAX = {
        ...
        intro:
            "Im Jahr 2030 verändern sich Max’ Tätigkeiten: Einige Entscheidungen bleiben klar handwerklich-menschlich (Human-Lead), bei anderen helfen schlaue Werkzeuge (KI-Assistenz), und manches läuft im Hintergrund automatisch (Auto-Run).",
        instruction: "Ordne die Tätigkeiten den passenden Bereichen zu:",
        buckets: [
