...
const roleProfiles = {
    1: {
        ...
        summary: "Tom (47) ist ein erfahrener Facharbeiter in der Produktion eines mittelständischen deutschen Maschinenbauunternehmens.",
        sections: [
            {
    ...
    2: {
        ...
        summary: "Lisa (29) arbeitet in einer kleinen Personalberatungs-Agentur und vermittelt passende Bewerberinnen an Unternehmen.",
        sections: [
            {
                title: "Qualifikation & Erfahrung",
                icon: "🎓",
    ...
    3: {
        ...
        summary: "Ali (35) arbeitet in einem städtischen Pflegeheim in Hamburg und betreut ältere Bewohnerinnen im Alltag.",
        sections: [
            {
                title: "Qualifikation & Erfahrung",
                icon: "🎓",
    ...
    4: {
        ...
        summary: "Marie (46) arbeitet seit 17 Jahren in der Heilbronner Stadtverwaltung (Denkmalschutz & Grünflächen). Nach einem Unfall nutzt sie einen rollstuhlgerechten Arbeitsplatz und digitale Tools.",
        sections: [
            {
                title: "Qualifikation & Erfahrung",
                icon: "🎓",
    ...
    5: {
        ...
        summary: "Elisa (30) schreibt und konzipiert Werbetexte in einer Agentur – von Social-Posts bis Kampagnenideen.",
        sections: [
            {
                title: "Qualifikation & Erfahrung",
                icon: "🎓",
...
const scenarioData = {
    1: { // Role Max
        ...
        3: { // Scenario 3
            title: "Willkommen 2030 – Tom Fischer, Facharbeiter Industrie",
            intro: "<div class='gl-intro-title'>Bis zum Jahr 2030 hat sich in deinem Unternehmen in Sachen KI Folgendes getan:</div><div class='gl-intro-body'>Spezial-Modelle mit Partnern entwickelt • Sensor- und Qualitätsdaten sehr gut aufbereitet • Sehr verlässliche Treffer, wenig Ausschuss • Fortlaufende Praxis-Trainings & Austausch mit Expertenteam • Standard-Schnittstellen • Nachweise schlank, aber vorhanden</div>",
            targets: {
                ki: 85,
                data: 90,
                reliability: 88,
    ...
    2: { // Role Toni Botelli
        1: { // Scenario 1
            title: "Willkommen 2030 – Lisa Bogner in der Personalberatung",
            intro: "<div class='gl-intro-title'>Bis zum Jahr 2030 hat sich in deinem Unternehmen in Sachen KI Folgendes getan:</div><div class='gl-intro-body'>Eigenes Job-Matching-Tool mitentwickelt • Kandidaten- und Stelleninfos klar strukturiert • Empfehlungen meist stabil; Zweitblick auf Personalie bleibt Standard • Regelmäßige Trainings • Teilweise eigene Lösungen, teils Zukauf – ausgewogen • Qualitätsprüfungen und Freigaben kosten etwas Zeit</div>",
            targets: {
                ki: 65,
                data: 70,
                reliability: 70,
        ...
        3: { // Scenario 3
            title: "Willkommen 2030 – Lisa Bogner in der Personalberatung",
            intro: "<div class='gl-intro-title'>Bis zum Jahr 2030 hat sich in deinem Unternehmen in Sachen KI Folgendes getan:</div><div class='gl-intro-body'>Branchen-Matching gemeinsam mit Kundschaft aufgebaut • Daten zu Fähigkeiten & Projekten sehr vollständig • Job-Vorschläge sehr treffsicher, gut nachvollziehbar • Fortlaufende Lernpfade & Feedbackrunden • Kooperationen mit mehreren Partnern • Prozesse klar geregelt, wenig Zusatzaufwand</div>",
            targets: {
                ki: 80,
                data: 85,
                reliability: 85,
    ...
    3: { // Role Ahmed Al-Hassan
        1: { // Scenario 1
            title: "Willkommen 2030 – Ali Saad im Pflegeheim",
    ...
    4: { // Role Maria Schmidt
        1: { // Scenario 1
            title: "Willkommen 2030 – Marie Meier in der Stadtverwaltung",
    ...
    5: { // Role Marcela Paz
        1: { // Scenario 1
            title: "Willkommen 2030 – Elisa Cruz in der Werbeagentur",
...
const quizData = {
    1: { // Max Sander
        1: [ // Scenario 1
            {
                question: "Was verbessert die Fehlererkennung der KI bei Toms Arbeit am deutlichsten?",
                options: {
            ...
            {
                question: "Worin hat sich Toms Arbeitsschwerpunkt spürbar verschoben?",
                options: {
            ...
            {
                question: "Wie geht Tom sinnvoll mit „KI ist schnell, aber nicht immer richtig“ um?",
                options: {
        ...
        2: [ // Scenario 2
            {
                question: "Warum fühlt sich Tom abhängiger als früher?",
                options: {
            ...
            {
                question: "Was sollte Tom einfordern, um weniger vom Anbieter abhängig zu sein?",
                options: {
        ...
        3: [ // Scenario 3
            ...
            {
                question: "Welche neue Rolle passt 2030 am besten zu Tom?",
                options: {
    ...
    2: { // Toni Botelli
        1: [ // Scenario 1
            {
                question: "Wobei hilft die hausinterne KI Lisa im Alltag am meisten?",
                options: {
                ...
                correctAnswer: "A",
                explanation: "Richtig: A. Vorarbeit + Leitfäden; Entscheidung & Feinschliff bleiben bei Lisa."
            },
            {
                question: "Warum richtet Lisa regelmäßige Prüfungen zu den KI-Vorschlägen ein?",
                options: {
            ...
            {
                question: "Was ändert sich spürbar in Lisas Arbeitstag?",
                options: {
                    A: "Mehr Fälle in kürzerer Zeit; Lisa ordnet ein, priorisiert und begründet Empfehlungen für die Unternehmen.",
                    B: "Fast nichts; es bleibt wie 2025.",
                    C: "Lisa macht nur noch Tool-Pflege, Gespräche fallen weg."
                },
                correctAnswer: "A",
        ...
        2: [ // Scenario 2
            {
                ...
                options: {
                    ...
                    B: "Weil Profile/Anforderungen oft Lücken haben – Lisa klärt Motivation, Team-Fit und offene Punkte nach.",
                    C: "Weil mündliche Gespräche gesetzlich Pflicht sind."
                },
                correctAnswer: "B",
                explanation: "Richtig: B. Unvollständige Daten ⇒ Lisa ergänzt durch Dialog."
            },
            {
                question: "Wie nutzt Lisa externe Tools sinnvoll, ohne sich darauf zu verlassen?",
                options: {
                ...
                correctAnswer: "B",
                explanation: "Richtig: B. Maschine vorsortiert; Qualität durch Lisas Prüfung."
            },
            {
                question: "Welche Abhängigkeit ist in Sachen KI realistisch – und wie geht Lisa damit um?",
                options: {
                    A: "Lizenzen/Anbieter setzen Rahmen; Lisa achtet zusätzlich auf Datenschutz & faire Verfahren.",
        ...
        3: [ // Scenario 3
            {
                question: "Warum sind Lisas Vorschläge für Chemie/Pharma besonders treffsicher?",
                options: {
            ...
            {
                question: "Wie verschiebt sich Lisas Rolle in diesem Setting?",
                options: {
                    ...
                    C: "Lisa entscheidet final, erklärt die KI-Vorschläge in einer Übersichtsseite und arbeitet am Feintuning bzw. an Einführungen in Unternehmen mit."
                },
                correctAnswer: "C",
    ...
    3: { // Ahmed Al-Hassan
        1: [ // Scenario 1
            {
                question: "Wobei unterstützt die KI Ali im Alltag am deutlichsten?",
                options: {
            ...
            {
                question: "Warum braucht Ali kontinuierliches Lernen in diesem Zeitraum?",
                options: {
            ...
            {
                question: "Was bleibt trotz Fortschritt eine reale Aufgabe für Alis Team?",
                options: {
        ...
        2: [ // Scenario 2
            ...
            {
                question: "Welcher Nutzen bleibt für Alis Pflegearbeit spürbar – trotz Abhängigkeiten?",
                options: {
        ...
        3: [ // Scenario 3
            {
                question: "Welche zusätzliche Rolle übernimmt Alis in diesem Szenario?",
                options: {
    ...
    4: { // Maria Schmidt
        1: [ // Scenario 1
            {
                question: "Wozu wird KI in Maries Verwaltung vor allem genutzt?",
                options: {
        ...
        3: [ // Scenario 3
            {
                question: "Was treibt die Verbesserungen in Maries Verwaltung am stärksten?",
                options: {
            ...
            {
                question: "Wie verschiebt sich Maries Rolle?",
                options: {
    ...
    5: { // Marcela Paz
        1: [ // Scenario 1
            {
                question: "Wie nutzt Elisa KI im täglichen Schreibprozess am sinnvollsten?",
                options: {
                    A: "KI liefert meist sendefertige Texte; menschliche Prüfung erfolgt nur stichprobenartig, um Zeit zu sparen.",
                    B: "KI liefert Entwürfe und Zielgruppen-Hinweise; Elisa steuert Ton & Idee und prüft nach.",
                    C: "KI dient höchstens als Rechtschreibhilfe; Konzept und Formulierungen entstehen komplett ohne KI."
                },
                correctAnswer: "B",
                explanation: "Richtig: B. Entwurf + Datenhilfe durch KI, kreative Führung und Qualitätsblick bei Elisa."
            },
            {
        ...
        2: [ // Scenario 2
            {
                question: "Was ist die größte Herausforderung für Elisa bei der Textarbeit?",
                options: {
                    ...
                    C: "Treffer der Tools schwanken; Elisa braucht mehrere Schleifen und steht unter Kostendruck durch Lizenzen."
                },
                correctAnswer: "C",
                explanation: "Richtig: C. Qualität variiert → mehr Iterationen; Lizenzen erhöhen Tempo-Druck."
            },
            {
                question: "Wie geht Elisa mit den genutzten KI-Werkzeugen praktisch um?",
                options: {
                ...
                correctAnswer: "B",
                explanation: "Richtig: B. Externe Modelle helfen, doch Kontrolle und Feinschliff bleiben bei Elisa."
            },
            {
        ...
        3: [ // Scenario 3
            ...
            {
                question: "Wie verändert sich Elisas Rolle im Team?",
                options: {
