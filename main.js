...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getQuizRoleTitle(roleId) {
        const roleNames = {
            1: "Tom Fischer, Facharbeiter in der Industrie",
            2: "Lisa Bogner in der Personalberatung",
            3: "Ali Saad im Pflegeheim",
            4: "Marie Meier in der Stadtverwaltung",
            5: "Elisa Cruz in der Werbeagentur"
        };
